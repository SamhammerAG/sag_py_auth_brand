...
brand: ContextVar[Optional[str]] = ContextVar("request_brand", default=None)
brand_alias: ContextVar[Optional[str]] = ContextVar("request_brand_alias", default=None)


def get_brand() -> str:
    """Gets the context local brand. This is the brand for backend logic.
    It contains the brand alias if set and otherwise the request brand.
